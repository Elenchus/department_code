...
class TestCase(ProposalTest):
    ...
    def extract_relevant_claims(self, header, code_list, group):
    ...
    def run_test(self):
        ...
        for _, group in tqdm(self.test_data):
            relevant_claims = self.extract_relevant_claims(self.processed_data.columns, self.required_params['codes_of_interest'], group)
